 ...
 * réserver une hauteur différente, et la page sauterait à l'arrivée sur ce
 * rayon-là — un défaut qu'on ne voit qu'en visitant cette page.
 *
 * La fiche d'un conte a le sien, sous `[slug]/` : celui-ci ne la couvre pas.
 */
